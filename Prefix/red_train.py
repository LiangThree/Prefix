...
def train(
    ...
    output_dir = os.path.join(output_dir, f'{data_num}_{data_type}_{layer_type}_{learning_rate}')
    
    if op_position == "qk":
        op_position = ["attn_q","attn_k"]
