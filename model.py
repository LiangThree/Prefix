...
class ActivationLayer(nn.Module):
    def __init__(self, hidden_size, update_layer, layer_type="all", op_position="", is_llama=False):
        super().__init__()
...
class ActivationModelRoberta(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        # print('ActivationModelRoberta forward')
...
class ActivationLLama(nn.Module):
    ...
    def __init__(self, base_model, op_position=None, layer_type="all", exclude_layers=[]):
        super().__init__()
        self.base_model = base_model
